...
| EventBus | `scripts/event_bus.gd` | 已有信号：`scene_change_requested`、`dialogue_requested`、`clue_interaction_details_requested` |
...
- Phase 5：Task 5.1 已完成（按用户指示提前执行）。

### 开发顺序调整（2026-04-07）

经 User 明确指示，本轮开发顺序调整为：

1. 暂缓 Phase 4（疑点与推理系统）代码实现。
2. 已完成 Phase 5 Task 5.1（线索栏 UI）。
3. 下一步回到 Phase 4 继续推进疑点与推理模块。
